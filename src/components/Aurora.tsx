...
export function Aurora() {
  return (
    ...
    >
      {/* Colour fields */}
      <div className="absolute -top-1/3 -left-1/4 h-[70vmax] w-[70vmax] rounded-full bg-[radial-gradient(circle,var(--color-signal-deep)_0%,transparent_62%)] opacity-[0.22] blur-3xl animate-drift" />
      <div
        className="absolute top-1/4 -right-1/4 h-[62vmax] w-[62vmax] rounded-full bg-[radial-gradient(circle,var(--color-pulse)_0%,transparent_62%)] opacity-[0.18] blur-3xl animate-drift"
        style={{ animationDelay: '-8s', animationDuration: '30s' }}
      />
      <div
        className="absolute -bottom-1/4 left-1/3 h-[54vmax] w-[54vmax] rounded-full bg-[radial-gradient(circle,var(--color-signal)_0%,transparent_65%)] opacity-[0.12] blur-3xl animate-drift"
